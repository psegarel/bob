...
To use these stylesheets, rename the files and omegabob with the name of your theme.
...
omegabob-alpha-default-narrow.css  
...
omegabob-alpha-default-normal.css
...
omegabob-alpha-default-wide.css
